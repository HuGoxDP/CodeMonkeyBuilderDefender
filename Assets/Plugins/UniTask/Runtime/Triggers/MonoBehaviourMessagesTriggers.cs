...
namespace Cysharp.Threading.Tasks.Triggers
{
    ...
    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleUpdateJobScheduledHandler
    {
        ...
        {
            core.Reset();
            return new UniTask<ParticleSystemJobData>(
                (IUniTaskSource<ParticleSystemJobData>)(object)this,
                core.Version
            );
        }
    }
    ...
    public sealed class AsyncParticleUpdateJobScheduledTrigger : AsyncTriggerBase<ParticleSystemJobData>
    {
        ...
        {
            return ((IAsyncOnParticleUpdateJobScheduledHandler)new AsyncTriggerHandler<ParticleSystemJobData>(
                this,
                true
